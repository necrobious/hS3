...
addContentMD5Header :: HTTP.HTTPRequest L.ByteString -> HTTP.HTTPRequest L.ByteString
addContentMD5Header req = insertHeaderIfMissing HdrContentMD5 mkMD5 req
	where mkMD5 = (encode . hash . Lazy.unpack) (rqBody req) 
